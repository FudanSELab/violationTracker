...
//     const detail = Array.isArray(datum.data.historyDetail)
//       ? datum.data.historyDetail[idx]
//       : datum.data.historyDetail;
//     if (
...
//         if (datum.data.historyDetail === undefined) {
//           return;
//         }
//         const UNIFY = `idx_${idx}_${datum.data.key}`;
...
//             const [live, death] =
//               detail.change?.[
//                 key as 'create' | 'remove' | 'modify' | 'normal'
//               ] ?? [];
...
//           ? LINE_DIR_COLOR
//           : hasFileChange(d.data, idx)
//           ? LINE_CHANGE_COLOR
//           : 'white',
//       )
//       // .attr('stroke-width', setFileChangeRectStrokeWidthWithPaddingTop)
//       .attr('fill', (d) =>
//         getValueOfHistoryDetail(
//           d.data.historyDetail,
//           idx,
//           'heatColor',
//           NIL_COLOR,
//         ),
...
//     drawFileDetail(node, idx, pluginRefs, onDetailClickGetExtra);
...
//           ];
//         }
//         const value = getValueOfHistoryDetail(
//           d.data.historyDetail,
//           idx,
//           'value',
//           0,
...
//     drawFileDetail(update, idx, pluginRefs, onDetailClickGetExtra);
//     update
//       .transition()
//       .duration(0)
...
//         const v = getValueOfHistoryDetail(
//           d.data.historyDetail,
//           idx,
//           'value',
//           '',
...
//         const next = getValueOfHistoryDetail(
//           d.data.historyDetail,
//           idx,
//           'value',
//           0,
