          ...
          outDiv.innerHTML =
            `
              ...
              e.item.getModel().target_name
                        ...
                        <h5>Relation: DependsOn(${
                          e.item.getModel().times
                        })</h5>` + str;
          break;
        case UNUSED_INCLUDE:
          outDiv.style.width = 'fit-content';
...
const showSmellDetail = function (smells, tableId) {
  ...
  html += '<tr>';
  html +=
    "<th style='text-align: center; vertical-align: middle'>SmellIndex</th>";
  html +=
    "<th style='text-align: center; vertical-align: middle'>SmellName</th>";
  html +=
    "<th style='text-align: center; vertical-align: middle'>NodeNumber</th>";
  html +=
    "<th style='text-align: center; vertical-align: middle'>NodeIndex</th>";
