...
It should be noted that the closing methods of violation cases in this paper are divided into FIXED and DELETED, which can be inferred by the values of **status** and **solve_way**. Please refer to our [website](https://github.com/FudanSELab/violationTracker) and the ICSE ViolationTracker paper for details.
